    ...
    <div className='grid grid-rows-[20px_1fr_20px] items-center justify-items-center min-h-screen p-8 pb-20 gap-16 sm:p-20 font-[family-name:var(--font-geist-sans)]'>
      ...
      <main className='flex flex-col gap-8 row-start-2 items-center sm:items-start'>
        ...
        <div className='flex gap-4 items-center flex-col sm:flex-row content-center'>
          <Button className='bg-foreground text-background rounded-full border border-solid border-transparent transition-colors hover:bg-[#383838] dark:hover:bg-[#ccc] text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5' onClick={redirectToAbout}>
            Go to About
          </Button>
          <Button className='bg-foreground text-background rounded-full border border-solid border-transparent transition-colors hover:bg-[#383838] dark:hover:bg-[#ccc] text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5' onClick={redirectToDashboard} disabled={loading}>
            Go to Dashboard
          </Button>
          <a className='rounded-full border border-solid border-transparent transition-colors flex items-center justify-center bg-foreground text-background gap-2 hover:bg-[#383838] dark:hover:bg-[#ccc] text-sm sm:text-base h-10 sm:h-12 px-4 sm:px-5' href='https://vercel.com/new?utm_source=create-next-app&utm_medium=appdir-template-tw&utm_campaign=create-next-app' target='_blank' rel='noopener noreferrer'>
            <Image className='dark:invert' src='https://nextjs.org/icons/vercel.svg' alt='Vercel logomark' style={{ width: 'auto', height: 'auto' }} width={20} height={20} />
            Deploy now
          </a>
